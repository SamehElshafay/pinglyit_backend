...
This is a test email sent from the admin dashboard's mail connection screen, through the
<strong>{{ $provider }}</strong> provider.
</p>
<p style="margin:0; font-size:14.5px; line-height:1.7; color:#334155;">
If it landed in your inbox, real password resets and verification codes will too.
</p>
</td>
</tr>
...
Sent to confirm the mail connection is configured correctly — no action needed.
</p>
</td>
</tr>
